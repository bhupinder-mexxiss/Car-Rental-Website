        ...
        <div className='bg-[#FAFAFA]'>
            <div className='container mx-auto py-20'>
                <div className='grid lg:grid-cols-2 gap-6 items-center'>
                    <img src={showroom} className='w-full h-auto object-cover max-w-[500px]' data-aos="zoom-in" data-aos-duration="800" />
                    <div>
                        <h2 data-aos="fade-left" className='text-3xl md:text-4xl lg:text-5xl font-semibold lg:leading-14 '>More Than Transportation, It's a Personalized Experience</h2>
