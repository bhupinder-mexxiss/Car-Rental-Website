...
const YourChoice = () => {
    return (
        <div className='container mx-auto py-20'>
            <div className='flex flex-col lg:flex-row gap-10 2xl:gap-18'>
                <div className='lg:w-2/5'>
                    <h2 data-aos="fade-right" className='text-3xl md:text-4xl lg:text-5xl lg:leading-14 font-semibold'>Your Journey, Your Choice – Here's Why CarRide Stands Out</h2>
                ...
                <div className='flex-1 flex flex-col sm:flex-row gap-6'>
                    <div className='sm:w-1/2 flex flex-col gap-6'>
                        <div className='bg-primary text-white rounded-3xl p-4 sm:p-6' data-aos="fade-up">
                            <div className='p-2 w-fit rounded-full bg-white/20'>
                                <img className='w-10' src={icon5} />
                            </div>
                            <p className='my-5 font-semibold text-xl sm:text-2xl'>Wide Fleet Variety</p>
                        ...
                        <div className='bg-[#fafafa] rounded-3xl p-4 sm:p-6' data-aos="fade-up" data-aos-delay="100">
                            <div className='p-3 w-fit rounded-full border-2 '>
                                <DateRangeOutlined />
                            </div>
                            <p className='my-5 font-semibold text-xl sm:text-2xl'>Transparent Picking</p>
                    ...
                    <div className='sm:w-1/2 flex flex-col gap-6'>
                        <div className='bg-[#fafafa] rounded-3xl p-4 sm:p-6' data-aos="fade-up" data-aos-delay="200">
                            <div className='p-3 w-fit rounded-full border-2 '>
                                <DateRangeOutlined />
                            </div>
                            <p className='my-5 font-semibold text-xl sm:text-2xl'>Easy Reservation System</p>
                        ...
                        <div className='bg-[#fafafa] rounded-3xl p-4 sm:p-6' data-aos="fade-up" data-aos-delay="300">
                            <div className='p-3 w-fit rounded-full border-2 '>
                                <DateRangeOutlined />
                            </div>
                            <p className='my-5 font-semibold text-xl sm:text-2xl'>Exceptional Customer Service</p>
