            ...
            <div className='container mx-auto'>
                <div className='flex justify-between items-end'>
                    <div className='lg:w-3/5'>
                        <h2 data-aos="fade-right" className='text-3xl md:text-4xl lg:text-5xl font-semibold lg:leading-14'>Your Queries Answered - Explore Common Questions About CarRide</h2>
                        <p data-aos="fade-right" data-aos-delay="200" className='lg:text-[17px] mt-4'>Read the testimonials from our valued customers who have chosen CarRide for their journeys. Their stories showcase the authentic experiences and satisfaction that define the CarRide difference</p>
                    </div>
                ...
                <div className='grid sm:grid-cols-2 gap-8 lg:gap-x-16 gap-y-14 mt-16'>
                    <div className='flex gap-4 w-full' data-aos="fade-up">
                        <img className='w-16 xl:w-22 h-16 xl:h-22 rounded-full border-2 border-primary object-cover' src={user1} />
                        <div>
