            ...
            <div className="bg-[#121212] text-white py-16">
                <div className="container">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="md:text-lg text-gray-300 max-w-2xl mx-auto">Driving excellence and premium experiences for all your journeys.</p>
                ...
                <div className="container">
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-[#525252] mb-6 md:text-lg">Founded in 2010, CarRide began with a simple mission: to transform the car rental experience by combining premium vehicles with exceptional customer service.</p>

                            <p className="text-[#525252] mb-6 md:text-lg">What started as a small fleet of just 10 vehicles has grown into a nationwide service offering hundreds of premium cars for every need and occasion. Our journey has been driven by our commitment to excellence and our passion for providing memorable travel experiences.</p>

                            <p className="text-[#525252] mb-6 md:text-lg">Today, CarRide stands as a leader in the rental industry, known for our extensive fleet, transparent pricing, and customer-first approach. We continue to innovate and expand, but our core values remain the same – quality, reliability, and exceptional service.</p>
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute -bottom-8 right-4 md:-left-8 bg-white rounded-xl shadow-lg p-6 w-48">
            ...
            <div className="py-16">
                <div className="container">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-[#525252] md:text-lg">The core principles that guide everything we do at CarRide, from customer service to fleet management.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="about-card p-8 bg-white border border-gray-100 shadow-sm">
                            ...
                            <p className="text-[#525252] text-sm md:text-base">We strive for excellence in every aspect of our service, from the quality of our vehicles to the professionalism of our staff. We believe in setting high standards and consistently exceeding them.</p>
                        </div>
                        ...
                        <div className="about-card p-8 bg-white border border-gray-100 shadow-sm">
                            ...
                            <p className="text-[#525252] text-sm md:text-base">Honesty and transparency are the foundations of our business. We believe in clear communication, fair pricing, and ethical practices in all our dealings with customers and partners.</p>
                        </div>
                        ...
                        <div className="about-card p-8 bg-white border border-gray-100 shadow-sm">
                            ...
                            <p className="text-[#525252] text-sm md:text-base">Our customers are at the heart of everything we do. We listen to their needs, anticipate their requirements, and go above and beyond to ensure their satisfaction and comfort.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                        <div>
                            ...
                            <div className="md:text-xl font-medium">Premium Cars</div>
                        </div>
                        <div>
                            <div className="text-4xl md:text-5xl font-bold mb-2">30+</div>
                            <div className="md:text-xl font-medium">Locations</div>
                        </div>
                        <div>
                            <div className="text-4xl md:text-5xl font-bold mb-2">50K+</div>
                            <div className="md:text-xl font-medium">Happy Customers</div>
                        </div>
                        <div>
                            <div className="text-4xl md:text-5xl font-bold mb-2">24/7</div>
                            <div className="md:text-xl font-medium">Customer Support</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='py-16'>
                <div className="container ">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-[#525252] md:text-lg">The dedicated professionals behind CarRide's success, committed to delivering exceptional service every day.</p>
                    </div>
            ...
            <div className="py-16">
                <div className="container">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-[#525252] md:text-lg">Don't just take our word for it – hear from our satisfied customers about their CarRide experience.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="p-8 bg-white rounded-xl shadow-md">
                            ...
                            <p className="text-[#525252] mb-6 italic text-sm md:text-base">"CarRide made my business trip so much easier. The car was immaculate, the pickup process was swift, and the staff were incredibly helpful. I'll definitely be using them again for future trips."</p>
                        ...
                        <div className="p-8 bg-white rounded-xl shadow-md">
                            ...
                            <p className="text-[#525252] mb-6 italic text-sm md:text-base">"Our family vacation was enhanced by the spacious SUV we rented from CarRide. The kids had plenty of room, and the vehicle was perfect for our road trip. The pricing was transparent with no hidden fees."</p>
                            <div className="flex items-center">
                        ...
                        <div className="p-8 bg-white rounded-xl shadow-md">
                            ...
                            <p className="text-[#525252] mb-6 italic text-sm md:text-base">"I needed a luxury car for a special occasion and CarRide delivered beyond my expectations. The vehicle was stunning, and the staff made me feel like a VIP. The entire experience was top-notch from start to finish."</p>
                            <div className="flex items-center">
            ...
            <div className='py-16 bg-[#fafafa]'>
                <div className="container">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-[#525252] md:text-lg">We collaborate with leading brands to provide you with the best vehicles and services.</p>
                    </div>
