...
import { formatAddress } from "../../Utils/comman";
        ...
        <div className=''>
            <div className="">
                ...
                <div className="bg-gray-100 rounded-b-xl">
                    {edit ?
                        <>
                            <ul className="px-4 flex gap-6 border-b border-border">
                                {tabs.map((tab, index) => (
                            ...
                            <div>
                                ...
                                <ul className="grid grid-cols-2 gap-3">
                                    ...
                                    <li>
                                        ...
                                        <span className="">{(user?.dob && new Date(user?.dob)?.toISOString().split("T")[0]) || "-"}</span>
                                    </li>
                                    <li>
                                        <p className="text-color2 text-sm">Address</p>
                                        <span className="">{formatAddress(user?.address)}</span>
                                    </li>
                                </ul>
